...
export const SchemaSettingsProvider: React.FC<SchemaSettingsProviderProps> = (
  props
) => {
  ...
  return (
    <SchemaSettingsContext.Provider
      value={{ collectionName: name, template: null, fieldSchema, ...others }}
    >
      {children}
    </SchemaSettingsContext.Provider>
  );
...
export const SchemaSettingsDropdown: React.FC<SchemaSettingsProps> = (
  props
) => {
  ...
  const changeMenu: DropdownProps["onOpenChange"] = useCallback(
...
export const SchemaSettingsModalItem: FC<SchemaSettingsModalItemProps> = (
  props
) => {
  const {
    hidden,
  ...
  return (
    <SchemaSettingsItem
      ...
      {...others}
      onClick={async () => {
        const values = asyncGetInitialValues
          ? await asyncGetInitialValues()
          : initialValues;
              ...
              >
                <FormBlockContext.Provider value={formCtx}>
                  <FormActiveFieldsProvider
                    name="form"
                    getActiveFieldsName={
                      upLevelActiveFields?.getActiveFieldsName
                    }
                  >
